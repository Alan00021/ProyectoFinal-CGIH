...
float movCocheH;
float offsetMovCocheH;
float movCocheV;
float offsetMovCocheV;
int cambio;
int randomCasilla;
float rotarVan;
float offsetRotarVan;
float movLlantaDIH;
float movLlantaDIV;
float movLlantaDDH;
float movLlantaDDV;
...
int main()
{
	...
	movBote = 0.0f;
	movBoteu = 0.0f;
	movOffsetB = 0.3f; //velocidad del bote
	rotHelice = 0.0f;
	rotHeliceOffset = 5.0f;
	rotBote = 0.0f;
	rotBoteOffset = 3.0f;
	uBote = true;
	dBote = false;
	...
	rotarLlanta = 0.0f;
	offsetRotarLlanta = 25.0f;
	movCocheH = 0.0f;
	offsetMovCocheH = 0.4f;
	movCocheV = 0.0f;
	offsetMovCocheV = 0.4f;
	cambio = 1;
	rotarVan = 0.0f;
	offsetRotarVan = 5.0;
	movLlantaDIH = 0.1f;
	...
	//////////////////Animación Nave Groot //////////////////////////////////
		...
		if (giro)
		{
			if (rotBote <= 180.0f)
			{
				rotBote += rotBoteOffset * deltaTime;
				rotHelice -= rotHeliceOffset * deltaTime;
		...
		model = glm::scale(model, glm::vec3(7.0f, 4.35f, 4.2f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//Carroceria
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-141.5f, -0.62f, 220.0f + movCocheV));
		modelaux = model;
		model = glm::scale(model, glm::vec3(1.55f, 1.55f, 1.55f));
		model = glm::rotate(model, 180 * toRadians, glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::rotate(model, rotarVan * toRadians, glm::vec3(0.0f, 1.0f, 0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		Van.RenderModel();
		...
		model = glm::scale(model, glm::vec3(1.6f, 1.6f, 1.6f));
		model = glm::rotate(model, (90) * toRadians, glm::vec3(0.0f, 0.0f, 1.0f));
		//model = glm::rotate(model, (90+90+90) * toRadians, glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::rotate(model, rotarLlanta * toRadians, glm::vec3(0.0f, 1.0f, 0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		Llanta_Van.RenderModel();
		...
		model = glm::scale(model, glm::vec3(1.6f, 1.6f, 1.6f));
		model = glm::rotate(model, (90) * toRadians, glm::vec3(0.0f, 0.0f, 1.0f));
		//model = glm::rotate(model, (3*90) * toRadians, glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::rotate(model, rotarLlanta * toRadians, glm::vec3(0.0f, 1.0f, 0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		Llanta_Van.RenderModel();
		...
		//Camaras en el mapa
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(205.0f, 13.5f, -60.0f));
		model = glm::scale(model, glm::vec3(0.5f, 0.5f, 0.5f));
		model = glm::rotate(model, 30 * toRadians, glm::vec3(0.0f, 1.0f, 0.0f));
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(55.0f, 13.5f, 170.0f));
		model = glm::scale(model, glm::vec3(0.5f, 0.5f, 0.5f));
		model = glm::rotate(model, 270 * toRadians, glm::vec3(0.0f, 1.0f, 0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		Camara31M.RenderModel();
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(30.0f, 13.5f, 170.0f));
		model = glm::scale(model, glm::vec3(0.5f, 0.5f, 0.5f));
		model = glm::rotate(model, 315 * toRadians, glm::vec3(0.0f, 1.0f, 0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		Camara31M.RenderModel();
		...
		//CEDRO
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(485.0f, -1.0f, 190.0f));
		model = glm::scale(model, glm::vec3(0.55f, 0.55f, 0.55f));
		model = glm::rotate(model, -90 * toRadians, glm::vec3(0.0f, 1.0f, 0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		cedroAC.RenderModel();
