...
int main()
{
	...
	//UNIVERSO LT
		...
		//ARBOL03LT-01
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(40.0f, -1.0f, -240.0f));
		model = glm::scale(model, glm::vec3(0.2f, 0.2f, 0.2f));
		model = glm::rotate(model, 90 * toRadians, glm::vec3(0.0f, 1.0f, 0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//ARBOL03LT-02
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(68.0f, -1.0f, -240.0f));
		model = glm::scale(model, glm::vec3(0.2f, 0.2f, 0.2f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		arbol03LT.RenderModel();
		...
		//ARBOL03LT-03
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(97.0f, -1.0f, -240.0f));
		model = glm::scale(model, glm::vec3(0.2f, 0.2f, 0.2f));
		model = glm::rotate(model, -90 * toRadians, glm::vec3(0.0f, 1.0f, 0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		arbol03LT.RenderModel();
		...
		//ARBOL03LT-04
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(125.0f, -1.0f, -240.0f));
		model = glm::scale(model, glm::vec3(0.2f, 0.2f, 0.2f));
		model = glm::rotate(model, 180 * toRadians, glm::vec3(0.0f, 1.0f, 0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		arbol03LT.RenderModel();
		...
		//ARBOL04LT-01
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(50.0f, -1.0f, -232.0f));
		model = glm::scale(model, glm::vec3(0.2f, 0.2f, 0.2f));
		model = glm::rotate(model, 90 * toRadians, glm::vec3(0.0f, 1.0f, 0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//ARBOL04LT-02
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(80.0f, -1.0f, -232.0f));
		model = glm::scale(model, glm::vec3(0.2f, 0.2f, 0.2f));
		model = glm::rotate(model, 90 * toRadians, glm::vec3(0.0f, 1.0f, 0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		arbol04LT.RenderModel();
		...
		//ARBOL04LT-03
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(110.0f, -1.0f, -232.0f));
		model = glm::scale(model, glm::vec3(0.2f, 0.2f, 0.2f));
		model = glm::rotate(model, 90 * toRadians, glm::vec3(0.0f, 1.0f, 0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		arbol04LT.RenderModel();
		...
		//Nave
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-450.0, 3.3, 80.0f));
		...
		//CapaGemaIzq
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(105.1f, 7.5f, -196.5f));	
		...
		//CapaGemaDer
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(106.2f, 7.5f, -196.5f));	
		model = glm::scale(model, glm::vec3(0.1f, 0.1f, 0.1f));		
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//Base Gema
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(105.8f, 6.45f, -196.5f));	
		model = glm::scale(model, glm::vec3(0.1f, 0.1f, 0.1f));		
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		baseGem.RenderModel();
		...
		//Gema
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(105.7f, 7.5f, -196.5f));	
		spotLights[1].SetPos(glm::vec3(105.78f, 7.0f, -196.4f));
		model = glm::scale(model, glm::vec3(0.1f, 0.1f, 0.1f));		
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		gem.RenderModel();
