...
int main()
{
	...
	//UNIVERSO LT
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(79.8f, 7.5f, -176.8f));
	...
	//UNIVERSO GG
		...
		//CapaGemaIzq
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(95.1f, 7.5f, -176.5f));
		...
		//CapaGemaDer
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(96.2f, 7.5f, -176.5f));
		model = glm::scale(model, glm::vec3(0.1f, 0.1f, 0.1f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//Base Gema
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(95.8f, 6.45f, -176.5f));
		model = glm::scale(model, glm::vec3(0.1f, 0.1f, 0.1f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		baseGem.RenderModel();
		...
		//Gema
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(95.7f, 7.5f, -176.5f));
	...
	//UNIVERSO AC
		...
		//RESTAURANTE
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(400.0f, 0.0f, 130.0f));
		model = glm::scale(model, glm::vec3(0.3f, 0.3f, 0.3f));
		model = glm::rotate(model, -90 * toRadians, glm::vec3(0.0f, 1.0f, 0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(388.0f, 0.0f, 130.0f));
		...
		//Museo
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(70.0f, -1.9f, -180.0f));
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(72.0f, 9.0f, -164.0f));
