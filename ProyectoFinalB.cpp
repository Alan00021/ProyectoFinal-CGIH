...
int main()
{
	...
	Llanta_Van = Model();
	Llanta_Van.LoadModel("Models/31M/llantaVan.obj");
	camara = Model();
	camara.LoadModel("Models/31M/cama31MP.obj");
	/*Tulio = Model();
	camara = Model();
	tripie = Model();
	Van = Model();
	Carroceria_Van = Model();
	Muro = Model();
	Microfono = Model();
	Bodoque = Model();*/

	//expendTexture = Texture("Textures/expendTextures.tga");		//Modificación por vertices
	...
	//BANDERAS PARA MODELOS DE 31M
	rotarLlanta = 0.0f;
	offsetRotarLlanta = 10.0f;
	int flag = 6;
	...
	//////////////////Animación Nave Groot //////////////////////////////////
		...
		*/
		...
		//model = glm::rotate(model, glm::radians(rotarLlanta), glm::vec3(1, 0, 0));
		...
		//model = glm::rotate(model, glm::radians(rotarLlanta), glm::vec3(0, 1, 0));
		////model = glm::rotate(model, 90 * toRadians, glm::vec3(0.0f, 0.0f, 1.0f));
		////model = glm::scale(model, glm::vec3(1.2f, 1.2f, 1.2f));
		//glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		//camara.RenderModel();
