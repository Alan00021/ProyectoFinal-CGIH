...
int main()
{
	...
	taquilla = Model();
	taquilla.LoadModel("Models/taquilla-AC.obj");
	bancaparque01 = Model();
	...
	plantaLuz = Model();
	plantaLuz.LoadModel("Models/plantaLuz.obj");
	conejo = Model();
	...
	while (!mainWindow.getShouldClose())
	{
		...
		*/
		...
		//BANCA PARQUE 01 - 01
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-27.0f, -1.0f, 59.0f));
		model = glm::scale(model, glm::vec3(0.2f, 0.2f, 0.2f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//UNIVERSO LT
			...
			//Elementos alrededor del estacionamiento
		...
		//Fauna
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, 0.65f, 60.0f));
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(136.0f, 7.4f, 119.0f));
		model = glm::scale(model, glm::vec3(0.6f, 0.29f, 0.6f));
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(133.0f, 7.5f, 126.0f));
		...
		*/
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(392.0f, 0.0f, 100.0f));
